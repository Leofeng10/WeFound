...
//                            databaseReference.child("IMAGE").setValue(upload);
    ...
    private void addUser() {
        ...
        Log.d("User_Information-------", user.toString() + currUser.getUid().toString());
        //databaseReference = FirebaseDatabase.getInstance().getReference("/USERS/");
        databaseUser.child("users").child(currUser.getUid().toString()).setValue(user).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
